...
def SyntheticExperiment():
    ...
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMAZL.dill'))
    datasets = dill.load(open('data/c_z_l_varying_d.dill', 'rb'))
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMCZL.dill'))
    datasets = dill.load(open('data/i_z_l_varying_d.dill', 'rb'))
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMIZL.dill'))
    datasets = dill.load(open('data/a_z_nl_varying_d.dill', 'rb'))
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMAZNL.dill'))
    datasets = dill.load(open('data/c_z_nl_varying_d.dill', 'rb'))
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMCZNL.dill'))
    datasets = dill.load(open('data/i_z_nl_varying_d.dill', 'rb'))
    dill.dump(varyingMExperiment(datasets[9][0], datasets[9][1], datasets[9][2], datasets[9][3], 9, None, 3, 6), open('SyntheticMIZNL.dill'))
